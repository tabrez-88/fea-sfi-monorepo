...
import { CircleCheck, FileText, Gift, Hash, Layers2, LockKeyhole, Star } from "lucide-react";
...
export default function Jumbotron() {
  ...
  return (
    <Container orientation="vertical" className="lg:gap-20">
      <div className="flex flex-col md:flex-row w-full gap-8">
        <div className="flex flex-col size-full gap-6 md:gap-12">
          <div className="flex flex-col gap-4 size-full xl:w-163.75">
          ...
          <div className="flex justify-center gap-2">
            {slides.map((_, index) => (
              <button
                ...
                className={`rounded-full cursor-pointer transition-all duration-300 ${index === selectedIndex
                  ? "w-6 h-2.5 bg-black"
                  : "size-2.5 bg-[#D9D9D9]"
                  }`}
              />
