# FEA-SFI Admin Portal — Phase 1 Complete Design Specification
...
```
FEA-SFI Admin Portal (standalone)
│
├── Auth (no sidebar)
│   ├── Login
│   ├── Register
...
│                                        │
│        Create Account                  │
│    Get started with FEA-SFI Admin          │
│                                        │
│    Full Name *                         │
│    ┌──────────────────────────────┐    │
│    │                              │    │
...
_32 screens. Every wireframe, component, form field, API endpoint, and interaction documented. Ready for Figma execution._
